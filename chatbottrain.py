...
train_text="""The current ratio for Liberty Medical
...
#model_path1 = r'set to your current directory'
...
ques_file = open("quesfile.txt","w")
ans_file = open("ansfile.txt","w")
for i in range(1,10):
